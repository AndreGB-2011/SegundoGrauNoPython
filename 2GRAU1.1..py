...
def GCL():
   ...
   while True:
      ...
      C3 = random.randint(1, 99)
      DR = random.randint(1, N4)
      D3 = DR**0.5
      if DR == B3**2-4*A3*C3:
         X1=(-B3+D3)/(2*A3)
         X2=(-B3-D3)/(2*A3)
...
while True:
    ...
    #Geração de equações
       ...
       if V3 == "y" or V3 == "Y":
            V6=input("Deseja definir máximo pra delta? Y/N:")
            if V6 =="N" or V6 == "n":
               gerar()
            elif V6 =="Y" or V6 =="y":
             #Definir delta
               print("")
               print("Para fazer sua equação de forma mais controlada")
               print("Pode adicionar um valor máximo a delta")
               print("o valor que colocar definira um número entre 1 e ele")
               print("")
               N4=int(input("Qual o valor máximo para Delta? "))
               GCL()
